...
5. **Address environment and model updates.** Provide guidance on how to replicate the prototypes outside SSP-Cloud. Consider containerising the solutions and documenting how to specify exact model versions to ensure reproducibility.
6. **Analyse data protection and ethics.** Work with experts in WP2 and WP5 to assess ethical implications, interpretability and quality assurance for LLM-based solutions.
