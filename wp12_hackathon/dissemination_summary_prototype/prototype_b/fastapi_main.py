...
import uvicorn
# streamlit is a cross-origin middleware
...
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=["http://localhost:8501"], # streamlit app runs on this port.
#     allow_methods=["*"],
#     allow_headers=["*"],
# )
...
async def upload_pdf(file: UploadFile = File(...)):
    """
    Receives a PDF and returns its filename and size.
